...
> 文档快照：2026-08-13  
> 正式扩展目录：`D:\Game\无名杀子琪懒人包v1.11.3-win32-x64\resources\app\extension\大模型AI`  
> 无名杀本体目录：`D:\Game\无名杀子琪懒人包v1.11.3-win32-x64`  
> 当前状态：本轮代码目标已经实现并通过静态/模块测试。
...
- 聊天/控制权/生命周期异常；
- 思考标签、输入保护和界面生命周期诊断。扩展不得包装十周年 UI 的视觉技能，也不得隐藏本体武将、牌、按钮的 `selected/selectable/glow_phase` 高光。
